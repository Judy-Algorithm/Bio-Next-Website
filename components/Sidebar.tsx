  ...
  return (
    <>
      ...
      >
        ...
        <div className="h-16 bg-transparent border-b border-white/20 flex items-center justify-between px-4 md:px-6 min-h-[64px]">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-lg md:text-xl font-bold text-white">Bio-Next</h1>
          </div>
        ...
        <div className="hidden md:block px-4 md:px-6 py-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 text-sm border border-white/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white/10 text-white placeholder-white"
            />
          </div>
        </div>
      ...
      <button
        ...
        className="fixed bottom-20 left-0 z-30 md:hidden p-3 bg-white border-r border-t border-gray-200 rounded-tr-lg shadow-lg hover:bg-gray-50 transition-colors"
      >
